...
CREATE TRIGGER _100_timestamps BEFORE INSERT OR UPDATE ON app_public.lilies FOR EACH ROW EXECUTE PROCEDURE app_private.tg__timestamps();
...
GRANT ALL ON SCHEMA public TO makon;
