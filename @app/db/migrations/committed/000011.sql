--! Previous: sha1:d36be0e9232e6f631725d7be9ed2fa862155aca3
--! Hash: sha1:0ee1cadbb25aa69df297e8c5c04ee79bf5871054
...
drop trigger if exists _500_audit_added on app_public.user_emails;
...
drop trigger if exists _500_audit_removed on app_public.user_emails;
...
drop trigger if exists _500_prevent_delete_last on app_public.user_emails;
...
drop trigger if exists _500_audit_removed on app_public.user_authentications;
create trigger _500_audit_removed
