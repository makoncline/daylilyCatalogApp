    ...
    <SharedLayout title="" query={query}>
      <Row justify="space-between" gutter={32}>
        <Col xs={24} sm={16}>
          ...
          <Paragraph>
            Made for daylily gardeners, this simple but feature-packed app will
            help you feel comfortable building a website to sell your daylilies.
          </Paragraph>
          ...
          <Paragraph>
            Website builders assume you're a tech guru and expert designer. What
            if you just want a simple website to show off your beautiful garden
            and sell your daylilies online? Daylily Catalog will take care of
            all of the details and give you shortcuts so you can immediatly have
            a great looking website for your garden.
          </Paragraph>
          ...
          <ol>
            ...
            <Li>
              <strong>Import your list</strong> from any spreadsheet for a small
              fee. Email me for details.
            </Li>
            <Li>
              <strong>Export your list</strong>, with photo links and data, to a
          ...
          <Paragraph>
            ...
            added to your listing. Or, manually add a daylily name. You can add
          ...
          <Paragraph>
            ...
            email, location, logo, photos, and garden description are standard,
          ...
          <Paragraph>
            ...
            default, but you can also make your own catalogs. Make a catalog of
            your favorites, this years new seedlings, new arrivals, or daylilies
            for a special sale.
          </Paragraph>
          ...
          <Paragraph>
            ...
            your listings, catalogs, or garden information at any time and your
            website will be updated in the morning. Your private daylily catalog
